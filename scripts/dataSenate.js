...
//       let table = document.getElementById("table-names");
//       table.innerHTML ="";
//       console.log(table)
//
//       let dataTable = data.results[0].members
//       dataTable.forEach(miembro => {
...
//       });
//     }
// console.log(crearTabla(data, "table-names"));
//
//
//
//
...
// //   let filtroMiembros = filtrarPorEstadoPartido(data, seleccionarPartidos, seleccionarEstados)
// //
...
//     crearTabla(data)
//   }else{
//     filtrarPorEstado(data, e.target.value)}
//
// })
