...
//     votosDefinidos: [],
// }
// estadisticas.republicanos = data.results[0].members.filter(member => member.party === "R");
// estadisticas.democratas = data.results[0].members.filter(member => member.party === "D");
// estadisticas.independientes = data.results[0].members.filter(member => member.party === "ID");
//
//
...
//     return porcentaje;
// }
// estadisticas.promediosVotosRepublicanos = (promedio(estadisticas.promediosVotosRepublicanos, estadisticas.republicanos));
// estadisticas.promediosVotosDemocratas = (promedio(estadisticas.promediosVotosDemocratas, estadisticas.democratas));
//
// function crearTablaSenateGlace(arrayR, arrayD, arrayID) {
//     let tablebody = document.getElementById("table-Senate-glace");
...
//     item1.innerHTML = `<td>Republicanos</td><td>${arrayR.length}</td><td>${estadisticas.promediosVotosRepublicanos}%</td>`;
//     item2.innerHTML = `<td>Democratas</td><td>${arrayD.length}</td><td>${estadisticas.promediosVotosDemocratas}%</td>`;
//     item3.innerHTML = `<td>Independientes</td><td>${arrayID.length}</td><td>0%</td>`;
//     item4.innerHTML = `<td>Total</td><td>450</td><td>${Number(estadisticas.promediosVotosRepublicanos) + Number(estadisticas.promediosVotosDemocratas) / 2 }</td>`;
//     tablebody.appendChild(item1);
//     tablebody.appendChild(item2);
//     tablebody.appendChild(item3);
//     tablebody.appendChild(item4);
// }
// console.log(crearTablaSenateGlace(estadisticas.republicanos, estadisticas.republicanos, estadisticas.republicanos))
//
// //mas masLeales
//
//
// estadisticas.conVotosMenorMayor = data.results[0].members.filter(member=> member.total_votes > 0);
// console.log(estadisticas.conVotos)
// estadisticas.conVotosMenorMayor = data.results[0].members.sort((a, b) =>{
...
// console.log(estadisticas.conVotos)
//
// porcentajeCantidad = Math.ceil(estadisticas.conVotosMenorMayor.length * 10 / 100)
//
//
// console.log(porcentajeCantidad);
//
// let republicanos = data.results[0].members.map(member=> member.votes_with_party_pct);
// let democratasTotalVotos = data.results[0].members.map(member=> member.votes_with_party_pct);
// let independientesTotalVotos = data.results[0].members.map(member=> member.votes_with_party_pct);
// republicanosTotalVotos = republicanos.reduce((acumulador, member) => {
//     return acumulador = acumulador + member.votes_with_party_pct;
//
// }, 0)
